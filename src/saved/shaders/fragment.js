...
float a =  step(fract(sin(uv.y -.6 ) + sin(uv.x *( 12. * sin(t) ) ) * .2), .6 );

float b =  step(fract(sin(uv.y -.6 ) + sin(uv.x *( 12. * sin(t) ) ) * .2), .4 );




color = mix(color, vec3(0., 0., 1.), step(uv2.x, .5));
color = mix(color, vec3(.4, 1., .4), step(uv2.y, a));

color = mix(color, vec3(1., .4, .1), step(uv2.y, b));
...
color = mix(color, vec3(0., 0., 1.), step(uv2.y, .5));

color = mix(color, vec3(1., .7, .7), step(uv2.y, .4));
