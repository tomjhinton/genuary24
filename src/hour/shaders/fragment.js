...
void main() {
  ...
  color = mix(color, 1.-color, step(fract(uv.x * 4.), .5 ));

  color = mix(color, 1.-color, step(fract(uv.y * 4.), .5 ));



  // color = mix(color, 1.-color, step(fract(uvR.x *2.), .5 + sin(t2)));

  // color = mix(color, 1.-color, step(fract(uvR.y *2.), .5 + cos(t2)));
...
//   if( color == vec3(1.)){
    ...
    alpha = mix(color, 1.-color, step(fract(uv.x * 200.), .3)).r;


    // color = mix(color, 1.-color, step(fract(uv.y * 20.), .3));
